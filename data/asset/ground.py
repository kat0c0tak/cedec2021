...
# Create new USD file
stage = Usd.Stage.CreateNew("ground.usda")
...
diffuseTextureSampler.CreateInput('file', Sdf.ValueTypeNames.Asset).Set("../texture/gravel/diff.png")
...
displacementTextureSampler.CreateInput('file', Sdf.ValueTypeNames.Asset).Set("../texture/gravel/disp.png")
...
normalTextureSampler.CreateInput('file', Sdf.ValueTypeNames.Asset).Set("../texture/gravel/nor.png")
...
roughnessTextureSampler.CreateInput('file', Sdf.ValueTypeNames.Asset).Set("../texture/gravel/rough.png")
